    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" value="prueba" name="title">
      </div>

      <div class="mb-3">
          <label for="author"form-label">Autor</label>
          <input type="text" class="form-control" value="prueba" name="author">
        </div>

        <div class="mb-3">
          <label for="pages"form-label">Número de páginas</label>
          <input type="text" class="form-control" value="123" name="pages">
        </div>

        <div class="mb-3">
          <label for="ISBN" form-label">ISBN</label>
          <input type="text" class="form-control" value="prueba" name="ISBN">
        </div>
