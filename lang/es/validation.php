...
return [
    ...
    */
    ...
    'between' => [
        ...
        'string' => 'El campo :attribute debe ser between :min y :max characters.',
    ],
    ...
    'declined' => 'El campo :attribute must ser declined.',
    'declined_if' => 'El campo :attribute must ser declined when :other is :value.',
    'different' => 'El campo :attribute y :other must ser different.',
    'digits' => 'El campo :attribute must ser :digits digits.',
    'digits_between' => 'El campo :attribute must ser between :min y :max digits.',
    ...
    'email' => 'El campo :attribute must ser a valid email address.',
    'ends_with' => 'El campo :attribute must end with one of following: :values.',
    'enum' => 'selected El campo :attribute is invalid.',
    'exists' => 'selected El campo :attribute is invalid.',
    'file' => 'El campo :attribute must ser a file.',
    'filled' => 'El campo :attribute field must have a value.',
    'gt' => [
        'array' => 'El campo :attribute must have more than :value items.',
        'file' => 'El campo :attribute must ser greater than :value kilobytes.',
        'numeric' => 'El campo :attribute must ser greater than :value.',
        'string' => 'El campo :attribute must ser greater than :value characters.',
    ],
    'gte' => [
        'array' => 'El campo :attribute must have :value items or more.',
        'file' => 'El campo :attribute must ser greater than or equal to :value kilobytes.',
        'numeric' => 'El campo :attribute must ser greater than or equal to :value.',
        'string' => 'El campo :attribute must ser greater than or equal to :value characters.',
    ],
    'image' => 'El campo :attribute must ser an image.',
    'in' => 'selected El campo :attribute is invalid.',
    'in_array' => 'El campo :attribute field does not exist in :other.',
    'integer' => 'El campo :attribute must ser an integer.',
    'ip' => 'El campo :attribute must ser a valid IP address.',
    'ipv4' => 'El campo :attribute must ser a valid IPv4 address.',
    'ipv6' => 'El campo :attribute must ser a valid IPv6 address.',
    'json' => 'El campo :attribute must ser a valid JSON string.',
    'lowercase' => 'El campo :attribute must ser lowercase.',
    'lt' => [
        'array' => 'El campo :attribute must have less than :value items.',
        'file' => 'El campo :attribute must ser less than :value kilobytes.',
        'numeric' => 'El campo :attribute must ser less than :value.',
        'string' => 'El campo :attribute must ser less than :value characters.',
    ],
    'lte' => [
        'array' => 'El campo :attribute must not have more than :value items.',
        'file' => 'El campo :attribute must ser less than or equal to :value kilobytes.',
        'numeric' => 'El campo :attribute must ser less than or equal to :value.',
        'string' => 'El campo :attribute must ser less than or equal to :value characters.',
    ],
    'mac_address' => 'El campo :attribute must ser a valid MAC address.',
    'max' => [
        'array' => 'El campo :attribute must not have more than :max items.',
        'file' => 'El campo :attribute must not ser greater than :max kilobytes.',
        'numeric' => 'El campo :attribute must not ser greater than :max.',
        'string' => 'El campo :attribute must not ser greater than :max characters.',
    ],
    'max_digits' => 'El campo :attribute must not have more than :max digits.',
    'mimes' => 'El campo :attribute must ser a file of type: :values.',
    'mimetypes' => 'El campo :attribute must ser a file of type: :values.',
    'min' => [
        'array' => 'El campo :attribute must have at least :min items.',
        'file' => 'El campo :attribute must ser at least :min kilobytes.',
        'numeric' => 'El campo :attribute debe ser mayor a :min.',
        'string' => 'El campo :attribute must ser at least :min characters.',
    ],
    'min_digits' => 'El campo :attribute debe contener al menos :min digitos.',
    'multiple_of' => 'El campo :attribute must ser a multiple of :value.',
    'not_in' => 'selected El campo :attribute is invalid.',
